<template>
  <div
    class="flex justify-center md:w-[100%] lg:w-[100%] sm:w-[100%] h-fit mb-4"
  >
    <div
      class="w-full p-8 border border-gray-300 rounded-lg shadow-sm bg-white"
    >
      <!-- Title with Badge -->
      ...
      <label class="block text-dark font-bold text-sm mb-3">{{
        $t("cards.donationCard.amount")
      }}</label>
      <div class="mt-6 flex flex-col lg:flex-row">
        <div class="flex lg:flex-row gap-3 flex-wrap items-center">
          <UButton
            ...
            variant="outline"
            color="selector"
            class="px-5 py-2.5 rounded-lg min-w-[80px]"
            :class="{
              'bg-[#138B96] text-white hover:bg-[#138B96] hover:text-white':
                donorStore.selectedAmount === amount,
            }"
          >
          ...
          <div class="flex flex-col items-end lg:flex-1 sm:flex-none">
            <UInput
              ...
              :placeholder="$t('cards.donationCard.customAmount')"
              class="w-full border-gray-300 px-5 py-2.5"
              color="white"
              varient="solid"
      ...
      <div class="mt-6">
        <div
          class="flex flex-col lg:flex-row justify-between items-start gap-6 flex-wrap"
        >
          <!-- Start Date -->
          <div class="flex-1">
            <label class="block text-dark font-bold text-sm mb-5">{{
              $t("cards.donationCard.startDate")
            }}</label>
            <UPopover :popper="{ placement: 'bottom-start' }">
              <UButton
                icon="i-heroicons-calendar-days-20-solid"
                :label="donorStore.startDate"
            ...
            <p
              v-if="donorStore.errors.startDate"
          ...
          <div class="flex-1">
            ...
            <p
              v-if="donorStore.errors.recurringType"
