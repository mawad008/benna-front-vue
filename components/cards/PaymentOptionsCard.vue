  ...
  <div class="flex justify-center md:w-[80%] lg:w-[60%] sm:w-[100%] h-fit  mb-4">
    <div class="w-4/5 p-6 border border-gray-300 rounded-lg shadow-sm bg-white">
      ...
      <div class="flex justify-center gap-4 mb-4">
        <UButton v-for="method in paymentMethods" :key="method.id" :class="{
        ...
        }" class="h-12 w-24 flex items-center justify-center rounded-lg bg-white" color="selector" variant="outline"
      ...
      <div class="mt-4">
        ...
        <UInput v-model="paymentStore.cardholderName" class="w-full border-gray-300 p-2 rounded-lg" color="white"
          varient="outline" />
      ...
      <div class="mt-4">
        ...
        <UInput v-model="paymentStore.cardNumber" class="w-full border-gray-300 p-2 rounded-lg" color="white"
          varient="outline" />
      ...
      <div class="mt-4 flex gap-4">
        <div class="flex-1">
          ...
          <UInput v-model="paymentStore.expiryDate" placeholder="شهر/سنة" class="w-full border-gray-300 p-2 rounded-lg"
            color="white" varient="outline" />
        ...
        <div class="flex-1">
          ...
          <UInput v-model="paymentStore.cvv" placeholder="CVV" class="w-full border-gray-300 p-2 rounded-lg"
            color="white" varient="outline" />
